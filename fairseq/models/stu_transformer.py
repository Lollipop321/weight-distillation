...
from fairseq.modules import (
    AdaptiveInput, AdaptiveSoftmax, CharacterTokenEmbedder, LayerNorm, StuMultiheadAttention,
...
@register_model('stu_transformer')
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(self, args, no_encoder_attn=False):
        ...
        if no_encoder_attn:
            ...
            self.encoder_attn = StuMultiheadAttention(
                self.embed_dim, self.enc_embed_dim, args.decoder_attention_heads,
                dropout=args.attention_dropout,
            )
...
@register_model_architecture('stu_transformer', 'stu_transformer')
...
@register_model_architecture('stu_transformer', 'stu_transformer_wmt_en_de')
def transformer_wmt_en_de(args):
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    args.relu_dropout = getattr(args, 'relu_dropout', 0.1)
    base_architecture(args)

@register_model_architecture('stu_transformer', 'stu_transformer_wmt_en_de_stu1')
...
@register_model_architecture('stu_transformer', 'stu_transformer_wmt_en_de_stu2')
