...
if [ $task == "zh2en" ]; then
        arch=stu_transformer_wmt_en_de_$stu
        init_model_path=output/$task/wd_kd_phase1_lr0.0007wu4000dr0.1$stu/checkpoint_new.pt
        share_embedding=0
...
cmd="python3 -u train.py ../data-bin/$data_dir ../data-bin/nist12.zh2en_after.kd.best
